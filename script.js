...
const eggs = [
  ...
  { name: "Vine Egg", icon: "Images/Eggs/Vine_Egg.png", Pets: [ { name: "Thorn Dragon", baseOdds: 4000, icon: "Images/Pets/Thorn_Dragon.png"}, { name: "Flower Pot", baseOdds: 100000, icon: "Images/Pets/Flower_Pot.png"}, { name: "Lovely Lotus", baseOdds: 1000000, icon: "Images/Pets/Lovely_Lotus.png"}, { name: "Fire Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Fire_Champion.png"}, { name: "Dark Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Dark_Champion.png"}, { name: "Earth Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Earth_Champion.png"}, { name: "Sky Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Sky_Champion.png"}], world: "3"},
  { name: "Lava Egg", icon: "Images/Eggs/Lava_Egg.png", Pets: [ { name: "Magma Cube", baseOdds: 4000, icon: "Images/Pets/Magma_Cube.png"}, { name: "Night Dweller", baseOdds: 100000, icon: "Images/Pets/Night_Dweller.png"}, { name: "Fire King", baseOdds: 3333334, icon: "Images/Pets/Fire_King.png"}, { name: "Hellshard", baseOdds: 1000000000, icon: "Images/Pets/Hellshard.png"}], world: "3"}
];
