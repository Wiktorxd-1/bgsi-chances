...
const eggs = [
  ...
  { name: "Shadow Egg", image: "Images/Eggs/Placeholder_Egg.webp", Pets: [ { name: "Celestial Split", baseOdds: 2857, icon: "Images/Pets/Celestial_Split.webp"}, { name: "Demonarium", baseOdds: 50000, icon: "Images/Pets/Demonarium.webp"}, { name: "Contrast", baseOdds: 1000000, icon: "Images/Pets/Contrast.webp"}, { name: "ACE", baseOdds: 2000000, icon: "Images/Pets/ACE.webp"}, { name: "Demonlord (Secret)", baseOdds:  33333333, icon: "Images/Pets/Demonlord.webp"}, { name: "Eternal Cucumber (Secret)", baseOdds: 100000000, icon: "Images/Pets/Eternal_Cucumber.webp"}, { name: "Hellfire (Secret)", baseOdds: 133333333, icon: "Images/Pets/Hellfire.webp"}, { name: "Diamond Ring (Secret)", baseOdds: 200000000, icon: "Images/Pets/Diamond_Ring.webp"}, {name: "Galactic Paladin (Secret)", baseOdds: 1000000000, icon: "Images/Pets/Galactic_Paladin.webp"}, { name: "Plasma Wolflord (Secret)", baseOdds: 2000000000, icon: "Images/Pets/Plasma_Wolflord.webp"}, { name: "Mariposa (Secret)", baseOdds: 5000000000, icon: "Images/Pets/Mariposa.webp"}, { name: "Shadow leviatan (Infinity)", baseOdds: 20000000000, icon: "Images/Pets/Shadow_Leviathan.webp"}], world: "limited"},
