...
const eggs = [
  ...
  { name: "Icy Egg", image: "Images/Eggs/Icy_Egg.png", Pets: [ { name: "Marshmallow", baseOdds: 200, icon: "Images/Pets/Marshmallow.png"}, { name: "Minty Serpent", baseOdds: 66667, icon: "Images/Pets/Minty_Serpent.png"}, { name: "Ice Winged Hydra", baseOdds: 333334, icon: "Images/Pets/Ice_Winged_Hydra.png"}, { name: "Giant Pearl (Secret)", baseOdds: 125000000, icon: "Images/Pets/Giant_Pearl.png"}], world: "3"},
  { name: "Vine Egg", image: "Images/Eggs/Vine_Egg.png", Pets: [ { name: "Thorn Dragon", baseOdds: 4000, icon: "Images/Pets/Thorn_Dragon.png"}, { name: "Flower Pot", baseOdds: 100000, icon: "Images/Pets/Flower_Pot.png"}, { name: "Lovely Lotus", baseOdds: 1000000, icon: "Images/Pets/Lovely_Lotus.png"}, { name: "Fire Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Fire_Champion.png"}, { name: "Dark Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Dark_Champion.png"}, { name: "Earth Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Earth_Champion.png"}, { name: "Sky Champion (Secret)", baseOdds: 500000000, icon: "Images/Pets/Sky_Champion.png"}], world: "3"},
  { name: "Lava Egg", image: "Images/Eggs/Lava_Egg.png", Pets: [ { name: "Magma Cube", baseOdds: 4000, icon: "Images/Pets/Magma_Cube.png"}, { name: "Night Dweller", baseOdds: 100000, icon: "Images/Pets/Night_Dweller.png"}, { name: "Fire King", baseOdds: 3333334, icon: "Images/Pets/Fire_King.png"}, { name: "Hellshard", baseOdds: 1000000000, icon: "Images/Pets/Hellshard.png"}], world: "3"}
];
...
function renderEggs() {
  animateEggList(() => {
    ...
    // Show all eggs if no world is selected
    if (selectedWorld) {
